...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            generate_create_query("adj1", 13), generate_drop_query("adj1")
        ),
        migrations.RunSQL(
            generate_create_query("adj2", 14), generate_drop_query("adj2")
        ),
        migrations.RunSQL(
            generate_create_query("adj3", 15), generate_drop_query("adj3")
        ),
    ]
