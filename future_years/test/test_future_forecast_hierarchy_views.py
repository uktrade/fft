...
class ViewArchivedForecastHierarchyTest(BaseTestCase):
    ...
    def test_view_dit_summary(self):
        ...
        # # Check that the second table displays the programme and the correct totals
        # self.check_programme_table(tables[PROGRAMME_TABLE_INDEX], 1, self.test_year)
        #
        # # Check that the third table displays the expenditure and the correct totals
        # self.check_expenditure_table(tables[EXPENDITURE_TABLE_INDEX], self.test_year)
        #
        # # Check that the fourth table displays the project and the correct totals
        # self.check_project_table(tables[PROJECT_TABLE_INDEX], self.test_year)
