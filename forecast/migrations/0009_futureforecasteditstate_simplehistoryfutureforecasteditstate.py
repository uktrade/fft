        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Ticking this option will close future forecast editing access to all non finance staff. Future forecast editing is still available to Finance business partners/BSCEs and admin.",
                    ),
                ),
                (
                    "lock_date",
                    models.DateField(
                        blank=True,
                        help_text="The future forecast editing is locked from the date entered. The future forecast editing will remain locked to users without 'unlocked' user status, until the date is removed from the input field above.",
                        null=True,
