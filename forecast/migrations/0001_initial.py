    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="If the lock date is set, after this date the system will remain locked until the date is removed",
                        null=True,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="forecast_budgetuploadmonthlyfigures",
                        to="forecast.FinancialCode",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="forecast_budgetmonthlyfigures",
                        to="end_of_month.EndOfMonthStatus",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="forecast_actualuploadmonthlyfigures",
                        to="forecast.FinancialCode",
                    ),
                ),
                (
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(archived_status__isnull=False),
                fields=(
                    "financial_code",
                    "financial_year",
                    "financial_period",
        ...
        migrations.AddConstraint(
            model_name="forecastmonthlyfigure",
            constraint=models.UniqueConstraint(
                condition=models.Q(archived_status__isnull=True),
