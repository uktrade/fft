...
UPDATE dw_simulation_mi_report_previous_year_actual
	SET
		previous_year_actual = dw_simulation_mi_report_previous_year_actual.previous_year_actual
		    + t1.previous_year_actual + t2.previous_year_actual + t3.previous_year_actual
	from
	(SELECT previous_year_actual, financial_period_code, financial_code, archived_financial_period_code
	...
	WHERE dw_simulation_mi_report_previous_year_actual.financial_code = t1.financial_code
	...
	AND dw_simulation_mi_report_previous_year_actual.archived_financial_period_code = t1.archived_financial_period_code
	AND dw_simulation_mi_report_previous_year_actual.archived_financial_period_code = t2.archived_financial_period_code
	AND dw_simulation_mi_report_previous_year_actual.archived_financial_period_code = t3.archived_financial_period_code
...
DELETE FROM dw_simulation_mi_report_previous_year_actual WHERE financial_period_code > 12;
...
UPDATE dw_simulation_mi_report_budget
	...
	from
	(SELECT budget, financial_period_code, financial_code, archived_financial_period_code
	...
	AND dw_simulation_mi_report_budget.archived_financial_period_code = t1.archived_financial_period_code
	AND dw_simulation_mi_report_budget.archived_financial_period_code = t2.archived_financial_period_code
	AND dw_simulation_mi_report_budget.archived_financial_period_code = t3.archived_financial_period_code
...
UPDATE dw_simulation_mi_report_forecast_actual
	...
	from
	(SELECT actual, forecast,  financial_period_code, financial_code, archived_financial_period_code
	...
	AND dw_simulation_mi_report_forecast_actual.archived_financial_period_code = t1.archived_financial_period_code
	AND dw_simulation_mi_report_forecast_actual.archived_financial_period_code = t2.archived_financial_period_code
	AND dw_simulation_mi_report_forecast_actual.archived_financial_period_code = t3.archived_financial_period_code
