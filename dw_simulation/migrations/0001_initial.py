...
SELECT 
       ...
       COALESCE(b.budget, 0)/100 as budget, 
	   COALESCE(f.actual, 0)/100 as actual,
	   COALESCE(f.forecast, 0)/100 as forecast,
	   ...
	   (COALESCE(f.actual, 0) + COALESCE(f.forecast, 0))/100 as period_forecast_actual,	
       ...
       COALESCE(b.ytd_budget, 0)/100 as ytd_budget,
 	   ...
 	   COALESCE(fa_ytd.ytd_forecast_actual, 0)/100 as ytd_forecast_actual,
 	   (COALESCE(fa_ytd.ytd_forecast_actual, 0) - COALESCE(b.ytd_budget, 0))/100 as ytd_actual_forecast_budget_variance,
	   ...
	   COALESCE(fp.forecast, 0)/100 as previous_period_forecast,
 	   COALESCE(p.previous_year_outturn, 0)/100 as previous_year_full_year_forecast,
