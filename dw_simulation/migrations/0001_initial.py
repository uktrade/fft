...
SELECT COALESCE(b.cost_centre_code, f.cost_centre_code) as cost_centre_code,
	   ...
	   (COALESCE(f.actual, 0) + COALESCE(f.forecast, 0))/100 as forecast_actual,	
	   ...
	   COALESCE(b.budget_outturn, 0)/100 as budget_outturn,
 	   COALESCE(cy_o.current_year_outturn, 0)/100 as current_year_outturn,
 	   (COALESCE(cy_o.current_year_outturn, 0) - COALESCE(b.budget_outturn, 0))/100 as current_year_forecast_budget_variance,
	   COALESCE(b.ytd_budget, 0)/100 as ytd_budget,
 	   ...
 	   (COALESCE(fa_ytd.ytd_forecast_actual, 0) - COALESCE(b.ytd_budget, 0))/100 as actual_forecast_budget_variance_ytd,
 	   COALESCE(rates.run_rate_ytd, 0)/100 as run_rate_ytd,
