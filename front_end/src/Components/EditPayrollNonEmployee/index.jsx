...
import Table from '../../Components/PayrollNonTable/index'
...
function EditPayrollNonEmployee() {
    console.log("EditPayrollNon component has been rendered");
    ...
    useEffect(() => {
        if (window.payroll_non_employee_data) {
            console.log('Payroll Non Data:', window.payroll_non_employee_data);
        } else {
            console.log('Payroll Non Data is not available');
        }

        if (window.payroll_non_employee_monthly_data) {
            console.log('Payroll Non Monthly Data:', window.payroll_non_employee_monthly_data);
        } else {
            console.log('Payroll Non Monthly Data is not available');
        }
