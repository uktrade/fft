...
function EditForecast() {
    ...
    return (
        <Fragment>
          {window.is_superuser && <ToggleCheckbox toggle={payrollToggle} setToggle={setPayrollToggle} id="payroll-forecast" value="payroll" label="Toggle payroll forecast rows" />}
            {errorMessage != null &&
