...
def step_impl(context):
    ...
    year_to_date_value = (
        ...
        .until(ec.presence_of_element_located((By.ID, "to_date_total_0")))
        .get_attribute("innerHTML")
    )

    year_total_row_0_value = (
        WebDriverWait(context.browser, 5000)
    ...
    col_5_total_value = (
        WebDriverWait(context.browser, 5000)
        .until(ec.presence_of_element_located((By.ID, "col_total_5")))
        .get_attribute("innerHTML")
    )

    col_6_total_value = (
        WebDriverWait(context.browser, 5000)
        .until(ec.presence_of_element_located((By.ID, "col_total_6")))
        .get_attribute("innerHTML")
    )
    ...
    ou_0_value = (
        WebDriverWait(context.browser, 5000)
        .until(ec.presence_of_element_located((By.ID, "ou_spend_0")))
        .get_attribute("innerHTML")
    )
    ...
    ou_total_value = (
        WebDriverWait(context.browser, 5000)
        .until(ec.presence_of_element_located((By.ID, "overspend-underspend-total")))
        .get_attribute("innerHTML")
    )
