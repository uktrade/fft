    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('split_coefficient', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(9999)])),
                ('row_number', models.IntegerField(default=0)),
                ('financial_code_to', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='to_upload_split_file_uploadpaysplitcoefficients', to='forecast.financialcode')),
                ('financial_period', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='upload_split_file_uploadpaysplitcoefficients', to='forecast.financialperiod')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directorate_code', models.CharField(max_length=6, verbose_name='Directorate Code')),
                ('split_coefficient', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(9999)])),
                ('financial_code_to', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='to_upload_split_file_previousyearpaysplitcoefficients', to='previous_years.archivedfinancialcode')),
                ('financial_period', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='upload_split_file_previousyearpaysplitcoefficients', to='forecast.financialperiod')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directorate_code', models.CharField(max_length=6, verbose_name='Directorate Code')),
                ('split_coefficient', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(9999)])),
                ('financial_code_to', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='to_upload_split_file_paysplitcoefficients', to='forecast.financialcode')),
                ('financial_period', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='upload_split_file_paysplitcoefficients', to='forecast.financialperiod')),
            ],
            options={
