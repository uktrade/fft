...
class SelectCostCentreView(
    UserPassesTestMixin,
    FormView,
):
    template_name = "payroll/edit/select_cost_centre.html"
    ...
    def get_form_kwargs(self):
        kwargs = super(SelectCostCentreView, self).get_form_kwargs()
        kwargs["user"] = self.request.user
        return kwargs

    def form_valid(self, form):
        self.cost_centre = form.cleaned_data["cost_centre"]
        return super(SelectCostCentreView, self).form_valid(form)
