...
class ImportPercentageTest(SplitDataSetup):
    ...
    def create_workbook(self, data_dictionary):
        ...
        self.data_worksheet.cell(column=COST_CENTRE_CODE_INDEX, row=1, value=COST_CENTRE_CODE)
        self.data_worksheet.cell(column=NAC_CODE_INDEX, row=1, value=NAC_CODE)
        self.data_worksheet.cell(column=PROGRAMME_CODE_INDEX, row=1, value=PROGRAMME_CODE)
        self.data_worksheet.cell(column=PROJECT_CODE_INDEX, row=1, value=PROJECT_CODE)
        self.data_worksheet.cell(column=ANALYSIS1_CODE_INDEX, row=1, value=ANALYSIS1_CODE)
        self.data_worksheet.cell(column=ANALYSIS2_CODE_INDEX, row=1, value=ANALYSIS2_CODE)
    ...
    def test_negative_percentage(self):
        ...
        assert (
                f"Row 2 error: Negative value in cell"
                in file_upload_obj.user_error_message
        )
    ...
    def test_percentage_too_high(self):
        ...
        assert (
                f"Row 2 error: Value higher than 100% in cell"
                in file_upload_obj.user_error_message
        )
    ...
    def test_total_percentage_too_high(self):
        ...
        assert (
                f"The sum of the percentages is higher than 100%"
                in file_upload_obj.user_error_message
        )
    ...
    def test_total_percentage_too_low(self):
        ...
        assert (
                f"The sum of the percentages is lower than 100%"
                in file_upload_obj.user_error_message
        )
