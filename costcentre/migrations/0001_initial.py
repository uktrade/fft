    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group_code",
                    models.CharField(max_length=50, verbose_name="Group Code"),
                ),
                (
                    "group_name",
                    models.CharField(max_length=300, verbose_name="Group Name"),
                ...
                (
                    "directorate_code",
                    models.CharField(max_length=50, verbose_name="Directorate Code"),
                ),
                (
                    "directorate_name",
                    models.CharField(max_length=300, verbose_name="Directorate Name"),
                ...
                (
                    "cost_centre_code",
                    models.CharField(max_length=50, verbose_name="Cost Centre Code"),
                ),
                (
                    "cost_centre_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "directorate_code",
                    models.CharField(
                        db_index=True, max_length=6, verbose_name="Directorate Code"
                    ),
                ),
                (
                    "directorate_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group_code",
                    models.CharField(
                        db_index=True, max_length=6, verbose_name="Group Code"
                    ),
                ),
                (
                    "group_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cost_centre_code",
                    models.CharField(
                        db_index=True, max_length=6, verbose_name="Cost Centre Code"
                    ),
                ),
                (
                    "cost_centre_name",
                ...
                (
                    "used_for_travel",
                    models.BooleanField(default="True", verbose_name="Used for Travel"),
                ),
                ("history_id", models.AutoField(primary_key=True, serialize=False)),
                ("history_date", models.DateTimeField()),
                ("history_change_reason", models.CharField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bsce_email",
                    models.EmailField(
                        db_index=True, max_length=254, verbose_name="BSCE email"
                    ),
                ),
                ("history_id", models.AutoField(primary_key=True, serialize=False)),
                ("history_date", models.DateTimeField()),
